        ...
        <main>
          ...
          <section className="pt-32 pb-16 bg-white">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
              <motion.span className="inline-block px-3 py-1 bg-harit-100 text-harit-700 rounded-full text-sm font-medium mb-4" initial={{
              opacity: 0,
              y: 20
            }} animate={{
              opacity: 1,
              ...
              <motion.h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6" initial={{
              opacity: 0,
              y: 20
            }} animate={{
              opacity: 1,
              ...
              <motion.p className="max-w-2xl mx-auto text-lg text-gray-600 mb-8" initial={{
              opacity: 0,
              y: 20
            }} animate={{
              opacity: 1,
          ...
          <section className="py-16 bg-gray-50">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-10 lg:gap-16">
                <motion.div className="bg-white p-8 rounded-xl shadow-sm" initial={{
                opacity: 0,
                x: -20
              }} whileInView={{
                opacity: 1,
          ...
          <section className="py-16 bg-white">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <div className="max-w-3xl mx-auto">
                <motion.h2 className="text-3xl font-bold text-gray-900 mb-6 text-center" initial={{
                opacity: 0,
                y: 20
              }} whileInView={{
                opacity: 1,
                ...
                <motion.div className="prose prose-lg mx-auto text-gray-600" initial={{
                opacity: 0,
                y: 20
              }} whileInView={{
                opacity: 1,
          ...
          <section className="py-16 bg-gray-50">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <div className="text-center mb-12">
                <motion.h2 className="text-3xl font-bold text-gray-900 mb-4" initial={{
                opacity: 0,
                y: 20
              }} whileInView={{
                opacity: 1,
                ...
                <motion.p className="max-w-2xl mx-auto text-lg text-gray-600" initial={{
                opacity: 0,
                y: 20
              }} whileInView={{
                opacity: 1,
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
                {teamMembers.map((member, index) => <motion.div key={index} className="bg-white rounded-xl overflow-hidden shadow-sm group hover:shadow-md transition-all duration-300" initial={{
                opacity: 0,
                y: 20
              }} whileInView={{
                opacity: 1,
                ...
                delay: 0.2 + index * 0.1
                    ...
                    <div className="p-6">
                      ...
                      <p className="text-harit-600 font-medium mb-2 text-left text-base">{member.position}</p>
                      {member.education && <p className="text-gray-500 text-sm">{member.education}</p>}
                    </div>
                  </motion.div>)}
              </div>
            </div>
