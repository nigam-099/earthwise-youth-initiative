...
const Hero = () => {
  ...
  return <div className="relative h-screen min-h-[600px] overflow-hidden">
      {/* Background image with parallax effect - increased opacity from 0.3 to 0.7 */}
      <div className="absolute inset-0 z-0 opacity-70" ref={parallaxRef}>
        <img src="/lovable-uploads/8798da8b-7f58-40bb-ad92-ffce57e95638.png" alt="Recyclable materials" className="w-full h-full object-cover" />
      </div>
      ...
      <div className="relative z-20 flex items-center justify-center h-full pt-20">
        <div className="max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <motion.h1 className="text-4xl md:text-6xl lg:text-7xl font-bold text-gray-900 mb-6 max-w-4xl mx-auto tracking-tight" initial={{
          opacity: 0,
          y: 20
        }} animate={{
          opacity: 1,
          ...
          <motion.p className="text-lg md:text-xl text-gray-700 max-w-2xl mx-auto mb-10" initial={{
          opacity: 0,
          y: 20
        }} animate={{
          opacity: 1,
      ...
      delay: 1.2
        ...
        <div className="w-8 h-12 rounded-full border-2 border-harit-500 flex items-start justify-center p-2">
          <motion.div className="w-1 h-2 bg-harit-500 rounded-full" animate={{
          y: [0, 12, 0],
          opacity: [1, 0.3, 1]
        }} transition={{
          duration: 1.5,
